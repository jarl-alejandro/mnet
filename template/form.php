...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    ...
    <div class="col-xs-12 col-md-6 bottom">
      <label for="hora-visita" class="col-xs-12 col-md-4" style="padding: 0;">Hora de la vistia</label>
    ...
    <div class="col-xs-12 center-flex">
      <button class="btn ripple-effect btn-raised btn-primary" style="margin-right:1em;" id="guardarPed">Guardar</button>
      <button class="btn ripple-effect btn-raised btn-danger" id="cancelarPed">Cerrar</button>
    </div>
  </div>
</div>
