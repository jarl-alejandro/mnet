...
$trabajador = $pdo->query("SELECT * FROM net_usuario");
...
<div class="panel panel-primary" style="background: #eee !important;margin-top: 8em;">
  ...
  <div class="panel-body">
   ...
   <div class="co-xs-12 col-md-6 bottom">
      ...
      <select class="form-control" id="trabajador" disabled>
        <option value="">Ingrese el trabajador</option>
        <?php while($row = $trabajador->fetch()){ ?>
        <option value="<?= $row['ced_usu'] ?>">
    ...
    <div class="col-xs-12 center">
      <button class="btn btn-primary" style="margin-right:1em;" id="guardar">Facturar</button>
