...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    ...
    <div class="col-xs-12 col-md-5 bottom">
      <label for="nombre">Selecione el servicio</label>    
    ...
    <div class="col-xs-12 col-md-6">
      <button class="btn btn-outline btn-warning col-xs-offset-8 col-md-offset-9 bottom" id="show-capsula">Materiales</button>
    ...
    <div class="col-xs-12 col-md-6">
      <button class="btn btn-outline btn-warning col-xs-offset-7 col-md-offset-9 bottom" id="show-herramienta">Herramientas</button>
      <div class="table-responsive col-xs-12">
        <table class="table table-striped table-bordered table-hover">
          <thead>
            <tr>
