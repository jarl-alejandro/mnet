 <div class="panel panel-primary">
  ...
  <div class="panel-body">
    ...
    <div class="col-xs-12 col-md-6 bottom">
      <label for="nombre-contacto">Ingrese el nombre del contacto</label>
    ...
    <div class="col-xs-12 col-md-6 bottom">
      <label for="telefono-contacto">Ingrese numero de telefono del contacto</label>
    ...
    <div class="col-xs-12 col-md-5 bottom">
      <label for="celular">Ingrese numero celular del proveedor</label>
    ...
    <div class="col-xs-12 col-md-6 bottom">
      <label for="celular-contacto">Ingrese numero celular del contacto</label>
    ...
    <div class="col-xs-12 col-md-5 bottom">
      <label for="direccion">Ingrese la direccion del proveedor</label>
