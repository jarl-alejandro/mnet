 ...
 <div class="panel panel-primary">
  ...
  <div class="panel-body">
    ...
    <div class="col-xs-12 col-md-5 bottom">
      <label for="nombre">Ingrese nueva bodega</label>
    ...
    <div class="col-xs-12 col-md-5 bottom">
      <label for="precio-venta-3">Ingrese precio de venta 3</label>
    ...
    <div class="col-xs-12 col-md-5 col-xs-offset-4 bottom">
