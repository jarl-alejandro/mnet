;(function () {
  ...
  function handleConfirmar (e) {
    ...
    swal({
      ...
      window.open(`procesos/mis-pedidos/reporte/individual.php?id=${id}`, "_blank","toolbar=yes, scrollbars=yes, resizable=yes, top=50, left=60, width=1200, height=600")
      $.ajax({
        type: "POST",
        url: "procesos/mis-pedidos/service/confirmar.php",
        data: { id }
      })
      .done(function (snap) {
