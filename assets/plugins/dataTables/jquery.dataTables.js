...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input style="height: 3.2em;" placeholder="Ingrese lo que desea buscar" type="search" class="'+classes.sFilterInput+'"/>';
	
		// var str = settings.oLanguage.sSearch;
		// var str = '<i class="fa fa-search"></i>';
		var str = `<span class="input-group-btn">
                      <button class="btn ripple-effect btn-raised btn-primary" type="button">
		...
		var filter = $('<div/>', {
			...
			.append( $('<label class="input-group"/>' ).append( str ) );
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sZeroRecords": "No se han econtrado concicencias"
		},
